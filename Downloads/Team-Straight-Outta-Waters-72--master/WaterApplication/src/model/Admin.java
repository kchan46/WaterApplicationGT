...
public class Admin implements Account {
    ...
    public Admin(String name, String username, String password, String email, String homeAddress) {
        this(name, username, password, email, homeAddress, null);
    }

    public Admin(String name, String username, String password, String email, String homeAddress, String title) {
        this.name = name;
