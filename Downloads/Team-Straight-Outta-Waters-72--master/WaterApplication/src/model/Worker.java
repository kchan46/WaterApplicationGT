...
/**
 * A User with Worker credentials.
 */
public class Worker implements Account {
    ...
    public Worker(String name, String username, String password, String email, String homeAddress) {
        this(name, username, password, email, homeAddress, null);
    }

    public Worker(String name, String username, String password, String email, String homeAddress, String title) {
        this.name = name;
