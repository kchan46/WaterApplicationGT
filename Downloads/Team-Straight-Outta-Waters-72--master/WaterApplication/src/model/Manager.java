...
/**
 * A user with manager credentials.
 */
public class Manager implements Account {
    ...
    public Manager(String name, String username, String password, String email, String homeAddress) {
        this(name, username, password, email, homeAddress, null);
    }

    public Manager(String name, String username, String password, String email, String homeAddress, String title) {
        this.name = name;
